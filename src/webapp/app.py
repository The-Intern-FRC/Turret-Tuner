...
# -----------------------------------------------------------------------------
def generate_pdf_report(analysis_results, tuned_values, system_info, filename):
    ...
    c.drawString(50, height - 100, f"Suggested Coefficients: {tuned_values}")
    c.drawString(50, height - 120, f"System ID: {system_info}")

    c.drawString(50, height - 160, "Analysis Summary:")
